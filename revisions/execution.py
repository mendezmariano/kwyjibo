...
class SafeCodeRunner(object):
    ...
    def parent(self, pid, r, w):
        ...
        if len(accumulated) > REVISION_OUTPUT_MAX_LENGTH:
            accumulated = str(accumulated[:REVISION_OUTPUT_MAX_LENGTH]) + str(_(TRUNCATION_MESSAGE))
    ...
    def child(self, r, w, script_name):
        ...
        print(captured_stdout.decode(), file = w) # Imprime al pipe que lo comunica con el padre
        sys.exit(exit_value)
